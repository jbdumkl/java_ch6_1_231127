...
public class Car {
	...
	public Car(String carName, String carColor, int carMaxSpeed) {//생성자->Car클래스로 객체를 선언할 때 자동으로 실행되는 메서드
//		System.out.println("Car클래스의 생성작사 실행됨!!");
		this.model = carName;
		this.color = carColor;
